...
def draw_floor():
    ...
    screen.blit(floor_surface, (floor_x_pos + 476,725))
def create_pipe():
...
def score_display(game_state):
    if game_state == 'main_game':
        ...
        score_rect = score_surface.get_rect(center = (238,100))
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = high_score_surface.get_rect(center = (238,703))
...
pygame.init()
screen = pygame.display.set_mode((476,850))
...
game_over_rect = game_over_surface.get_rect(center = (238,405))

flap_sound = pygame.mixer.Sound('audio_wing.wav')
death_sound = pygame.mixer.Sound('audio_hit.wav')
